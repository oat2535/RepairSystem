                          ...
                          <form action="" method="post" enctype="multipart/form-data">
                              <div class="card-body">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-7">
                                          <textarea name="product_detail" id="product_detail" class="form-control"><?php echo $rowProduct['product_detail']; ?></textarea>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-4">
                                          <input type="text" name="product_qty" class="form-control" value="<?php echo $rowProduct['product_qty']; ?>">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-4">
                                          <input type="text" name="product_price" class="form-control"  value="<?php echo $rowProduct['product_price']; ?>">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-4">
                                          ภาพเก่า <br>
                                          <a data-fancybox href="../assets/product_img/<?= $rowProduct['product_image']; ?>">
